...
export default function HeroSection(){
    return <section>
        <div className="relative mx-auto flex flex-col z-0 items-center justify-center 
            ...
            <div>
              ...
              to-rose-500 hover:from-rose-500 hover:to-slate-900 hover:no-underline 
              shadow-lg duration-300" >
               <Link href="/#pricing" className="flex gap-2 items-center">
                  <span>Try Generationali</span>
